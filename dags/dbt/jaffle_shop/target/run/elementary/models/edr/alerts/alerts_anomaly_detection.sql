create or replace view `dbt_gopal__jaffle_shop_elementary`.`alerts_anomaly_detection`
...
with elementary_test_results as (
    select * from `dbt_gopal__jaffle_shop_elementary`.`elementary_test_results`
),
