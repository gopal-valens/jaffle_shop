create or replace view `dbt_gopal__jaffle_shop_elementary`.`anomaly_threshold_sensitivity`
...
with metrics_anomaly_score as (
    ...
    select * from `dbt_gopal__jaffle_shop_elementary`.`metrics_anomaly_score`
