create or replace view `dbt_gopal__jaffle_shop_elementary`.`snapshot_run_results`
...
with dbt_run_results as (
    select * from `dbt_gopal__jaffle_shop_elementary`.`dbt_run_results`
),

dbt_snapshots as (
    select * from `dbt_gopal__jaffle_shop_elementary`.`dbt_snapshots`
)
